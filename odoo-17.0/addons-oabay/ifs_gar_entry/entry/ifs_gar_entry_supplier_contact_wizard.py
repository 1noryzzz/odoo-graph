...
class GuaranteeAccountsRecEntrySupplierContactWizard(models.TransientModel):
    _name = 'ifs.gar.entry.supplier.contact.wizard'
    _inherit = ['ifs.gar.entry.step']
    _description = '供应方进件流程--联系人信息'
    ...
    def default_get(self, default_fields):
        ...
        if 'entry_id' in defaults:
            ...
            defaults.setdefault('contact_finance_name', entry.finance_name)
            defaults.setdefault('contact_finance_phone', entry.finance_phone)
    ...
    contact_finance_name = fields.Char('财务联系人', required=True)
    contact_finance_phone = fields.Char('财务电话', required=True)
    ...
    def action_next(self):
        self.entry_id.write({
            ...
            'finance_name': self.contact_finance_name,
            'finance_phone': self.contact_finance_phone,
        })
