...
class GuaranteeAccountsRecEntryFranchiseeRjWizard(models.TransientModel):
    _name = 'ifs.gar.entry.franchisee.reject.info.wizard'
    _inherit = ['ifs.gar.entry.step']
    _description = '合伙人进件流程--退回补充资料'
    ...
    def action_next(self):
        return self.env['ifs.gar.entry.franchisee'].create({
