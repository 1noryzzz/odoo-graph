...
class InclusiveFinancingUpdateFunderSign(models.TransientModel):
    _name = 'ifs.partner.funder.sign.wizard'
    _description = '资金方存留签名的向导类'
    _order = 'create_date'

    funder_id = fields.Many2one(
        'ifs.partner.funder',
        string='资金方', index=True, ondelete='restrict')
