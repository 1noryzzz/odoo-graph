...
class InclusiveFinancingUpdateFactorSign(models.TransientModel):
    _name = 'ifs.partner.factor.sign.wizard'
    _description = '保理方存留签名的向导类'
    _order = 'create_date'

    factor_id = fields.Many2one(
        'ifs.partner.factor',
        string='保理方', index=True, ondelete='restrict')
